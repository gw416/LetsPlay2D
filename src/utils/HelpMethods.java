...
public class HelpMethods {
	...
	// use level data to find the amtching level sprite. level data will be either
	// red green or blue
	...
	public static ArrayList<GameContainer> GetContiners(BufferedImage img){
		ArrayList<GameContainer> list = new ArrayList<GameContainer>();
		for(int j=0; j< img.getHeight(); j++) {
			for(int i=0; i<img.getWidth(); i++) {
				Color color = new Color(img.getRGB(i, j)); // X, Y
				int value = color.getBlue();
